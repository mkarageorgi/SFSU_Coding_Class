...
### In the second  tutorial, we will learn how to fit multiple dose resposnse curves using the data from the pig, the monarch and the mutant Drosophila lines (Figure 3a) ### 
...
p3 <- ggplot(data = DoseResponse_Data_All,
       aes(x = Dose, y = Activity,group= Species_ATPase, color= Species_ATPase)) + 
  geom_point(aes(color=Species_ATPase), size = 0.5) + 
